...
> **Status:** ✅ Active | **Purpose:** Source of truth for which Founder Log day was actually posted, when, and where. The daily posting Routine reads this file first on every run to find the next day to post. | **Last Updated:** 2026-07-20
...
**Not yet posted, but fully drafted and ready:** 004, 005, 007, 009 (copy in `batch-01-linkedin-captions.md`); 014 (copy in `batch-02-linkedin-captions.md`, timely insert — see `../../docs/founder-log-calendar.md`'s 2026-07-20 changelog); 035 (copy in `batch-03-linkedin-captions.md`, timely insert — see the calendar's second 2026-07-20 changelog entry). Graphics for all of these are rendered in `../renders/`; blog posts are already in `backend/src/blog-content.js`.
