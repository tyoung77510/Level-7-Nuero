...
`.trim()
},
  {
    ...
    description: "Self-reported and measured schedule quality differ. Why Ordo7 only shows numbers it can back up — and marks the rest unavailable instead of guessing.",
...
`.trim()
  },
  {
    ...
    description: "The first of DCMA's 14 checks is the simplest: every activity needs something driving it and something depending on it. Here's why it catches so much.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Compliance-driven maintenance schedules don't get extensions. How enforcing schedule discipline on a water utility program cut safety incidents by 9%.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Building in public isn't a growth tactic — it's how I build something honest. Why the Founder Log exists, and what 'follow the journey' means right now.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "A capital-projects boom is outpacing the supply of trained project controls talent — the gap gets absorbed by whoever's already on the project.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "The second of DCMA's 14 checks flags something most schedulers have used without naming: starting before a predecessor is done. Why DCMA wants leads at zero.",
    category: 'Founder Log',
    contentHtml: `
