...
`.trim()
},
  {
    ...
    description: "Self-reported and measured schedule quality are different things. Ordo7 only shows numbers it can back up, and marks the rest unavailable instead of guessing.",
...
`.trim()
  },
  {
    ...
    description: "The first of DCMA's 14 schedule-health checks is the simplest: every activity needs something driving it and something depending on it.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Building in public isn't a growth tactic here — it's the only way I know how to build something honest. Why the Founder Log exists.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "A capital-projects boom is outpacing trained project controls talent. The gap doesn't disappear — it gets absorbed by whoever's already on the project.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "You don't need a PSP certification to catch a bad baseline. 5 concrete things to check in a contractor's schedule before you sign off.",
...
`.trim()
  },
  {
    ...
    description: "The second of DCMA's 14 checks flags something most schedulers use without naming it: an activity starting before its predecessor is done.",
    category: 'Founder Log',
    contentHtml: `
