...
`.trim()
  ...
  description: "Out-of-sequence progress means an activity started before its FS predecessor finished. Here's why it happens in P6, how it skews float, and how to fix it.",
  category: 'DCMA & compliance',
  toc: [
...
`.trim()
  ...
  description: "A schedule health score is a 0-100 number built from real DCMA-style checks on your P6 or MS Project file. Here's what it measures, dimension by dimension.",
  category: 'DCMA & compliance',
  toc: [
...
`.trim()
},
  {
    ...
    description: "Self-reported and objectively measured schedule quality differ. Here's why Ordo7 only shows numbers it can back up, and marks the rest unavailable.",
...
`.trim()
  },
  {
    ...
    description: "The first of DCMA's 14 schedule-health checks is the simplest: every activity needs something driving it and something depending on it. Here's why it matters.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "PMP-certified, deep in Primavera P6 and EVM, across $100M+ in portfolios and five industries. Powerful tools, never built for the person running the schedule.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Building in public isn't a growth tactic here — it's the only way I know how to build something honest. Here's why the Founder Log exists right now.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "A capital-projects boom is outpacing the supply of trained project controls talent — the gap gets absorbed by whoever's already on the project. Usually the PM.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "You don't need a PSP certification to catch a bad baseline. Here are 5 things to check in a contractor's schedule before you sign off — and why each matters.",
...
`.trim()
  },
  {
    ...
    description: "DCMA's second check flags something most schedulers have used without naming: starting an activity before its predecessor is done. DCMA wants it at zero.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Data centers and manufacturing plants are surging right now — the project controls function meant to run them hasn't scaled to match. A look from the inside.",
    category: 'Founder Log',
    contentHtml: `
