...
`.trim()
  ...
  description: "A schedule health score is a 0-100 number from real DCMA-style checks on your P6 or MS Project file. What it measures, dimension by dimension.",
  category: 'DCMA & compliance',
  toc: [
...
`.trim()
},
  {
    ...
    description: "Self-reported and objectively measured schedule quality are different things. Why Ordo7 only shows numbers it can back up, marking the rest unavailable.",
...
`.trim()
  },
  {
    ...
    description: "The first of DCMA's 14 checks is the simplest: every activity needs something driving it and something depending on it. Why that rule catches so much.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Compliance-driven maintenance schedules don't get extensions. A water utility program where enforcing schedule discipline cut safety incidents by 9%.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "PMP-certified, deep in P6 and EVM, across $100M+ in portfolios and five industries. Powerful tools, never built for the person running the schedule.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Building in public isn't a growth tactic here — it's the only way I know how to build something honest. Why the Founder Log exists and what it means.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "You don't need a PSP certification to catch a bad baseline. 5 things to check in a contractor's schedule before you sign off — and why each matters.",
...
`.trim()
  },
  {
    ...
    description: "The second of DCMA's 14 checks flags something schedulers use without naming: an activity starting before its predecessor is done. Why DCMA wants leads at zero.",
    category: 'Founder Log',
    contentHtml: `
...
`.trim()
  },
  {
    ...
    description: "Data centers and manufacturing plants are surging — the project controls function meant to run them hasn't scaled to match. A firsthand look.",
    category: 'Founder Log',
    contentHtml: `
